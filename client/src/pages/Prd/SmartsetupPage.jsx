...
import pr_setupcoilma from "../../assets/images/pr_setupcoilma.jpg";
import pr_setupcoilpm from "../../assets/images/pr_setupcoilpm.jpg";
import pr_setupfinal from "../../assets/images/pr_setupfinal.jpg";

const products = [
  {
    id: 1,
    name: "pr_setupcoilma",
    href: "http://10.121.42.48:8118/",
    imageSrc: pr_setupcoilma,
  },
  {
    id: 2,
    name: "pr_setupcoilpm",
    href: "http://10.121.42.48:8120/",
    imageSrc: pr_setupcoilpm,
  },
  {
    id: 3,
    name: "pr_setupfinal",
    href: "http://10.121.42.48:8122/",
    imageSrc: pr_setupfinal,
  },
  // More products...
];
